    ...
    <div class="col-12 ukuran">
        <div class="row d-flex flex-column justify-content-center align-items-center">
            <div class="border col-md-10 col-lg-9 d-flex flex-column justify-content-center align-items-center">
                ...
                <p class="col-11 py-0 bg-dark mb-3"></p>
                    ...
                    <div class="body">
                        <table class="">
                            ...
                            <tr>
                                <td>Tanggal</td>
                                <td>:</td>
                                <td>{{ \Carbon\Carbon::parse($tanggal)->locale('id')->translatedFormat('d M Y') }}</td>
                            </tr>
                            <tr>
                                <td>Judul</td>
                                <td>:</td>
                ...
                <div class="signature">
                    <p class="d-block mb-0">Semarang, {{ \Carbon\Carbon::now()->locale('id')->translatedFormat('d M Y') }}</p>
                </div>
                <p class="text-center d-block">Dewan Penguji</p>
                
                <div class="row">
                    <div class="col text-center">
                        <p class="d-block mb-5">Penguji 1</p>
                        <p class="nama-penguji d-block">{{ $penguji1 }}</p>
                    </div>
                    <div class="col text-center">
                        <p class="d-block mb-5">Penguji 2</p>
                        <p class="nama-penguji d-block">{{ $penguji2 }}</p>
                    </div>
                </div>
                <div class="row">
                    <div class="col text-center">
                        <p class="d-block mb-5">Pembimbing 1</p>
                        <p class="nama-penguji d-block">{{ $pembimbing1 }}</p>
                    </div>
                    <div class="col text-center">
                        <p class="d-block mb-5">Pembimbing 2</p>
                        <p class="nama-penguji d-block">{{ $pembimbing2 }}</p>
                    </div>
                </div>
            </div>
        </div>
