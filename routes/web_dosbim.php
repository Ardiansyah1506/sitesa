...
Route::prefix('dosen-pembimbing')->name('dosbim.')->group(function() {
    ...
    Route::controller(BimbinganController::class)->group(function() {
        ...
        Route::post('/bimbingan/catatan-2/store', 'storeCatatanBab2')->name('store-catatan-bab-2');
        Route::post('/bimbingan/catatan-3/store', 'storeCatatanBab3')->name('store-catatan-bab-3');
        Route::post('/bimbingan/catatan-4/store', 'storeCatatanBab4')->name('store-catatan-bab-4');
        Route::post('/bimbingan/catatan-5/store', 'storeCatatanBab5')->name('store-catatan-bab-5');
        Route::post('/bimbingan/catatan-6/store', 'storeCatatanBab6')->name('store-catatan-bab-6');
